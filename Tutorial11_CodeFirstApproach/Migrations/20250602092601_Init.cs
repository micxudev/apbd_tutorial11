    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "JohnDoctor@email.com", "JohnDoctor", "DoeDoctor" },
                    { 2, "JaneDoctor@email.com", "JaneDoctor", "DoeDoctor" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateOnly(1990, 1, 1), "JohnPatient", "DoePatient" },
                    { 2, new DateOnly(1990, 1, 1), "JanePatient", "DoePatient" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateOnly(2025, 5, 20), new DateOnly(2025, 5, 20), 2, 1 },
                    { 2, new DateOnly(2025, 5, 20), new DateOnly(2025, 5, 20), 1, 2 }
                });
